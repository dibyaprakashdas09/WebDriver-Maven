...
public class TestBase {
	...
	//Customizes CLICK Method
	public void click(String locator) {

		if (locator.endsWith("_CSS")) {
			//Only Select Locator which ends with CSS tag
			driver.findElement(By.cssSelector(OR.getProperty(locator))).click();
		} else if (locator.endsWith("_XPATH")) {
			//Only Select Locator which ends with XPATH tag
			driver.findElement(By.xpath(OR.getProperty(locator))).click();
		} else if (locator.endsWith("_ID")) {
			//Only Select Locator which ends with ID tag
			driver.findElement(By.id(OR.getProperty(locator))).click();
		}
		CustomListeners.testReport.get().log(Status.INFO, "Clicking on : " + locator);
	}

	//Customizes TYPE Method :- Input Text
